...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "absolute left-1.5 h-full py-3 duration-300 ease-in-out rtl:right-1.5 tree-indicator",
        className,
      )}
      {...props}
    />
  ...
  (
    ...
    return (
      ...
      >
           ...
           className={cn(
             `flex items-center gap-1 text-sm px-2 py-1`,
             className,
        ...
        >
             ...
             ? (openIcon ?? <FolderOpenIcon style={{ width: '18px', height: '18px' }} />)
             : (closeIcon ?? <FolderIcon style={{ width: '18px', height: '18px' }} />)}
          <span>{element}</span>
        </AccordionPrimitive.Trigger>
  ...
  (
    ...
    return (
      <button
        ...
        disabled={!isSelectable}
        className={cn(
          "flex w-fit items-center gap-1 px-2 py-1 text-sm duration-200 ease-in-out rtl:pl-1 rtl:pr-0",
          isSelectable ? "cursor-default" : "cursor-not-allowed opacity-50",
