...
export function BottomMiniDialog({ content, mode = 'reading', onModeChange }: BottomMiniDialogProps) {
  ...
  // Handle click outside, escape key to close dropdown, and keyboard shortcuts
  useEffect(() => {
    ...
    // Always listen for keyboard shortcuts, regardless of dropdown state
          ...
          {showModeDialog && (
            <div className="bottom-mini-dialog__mode-dropdown">
               ...
               >
                 ...
                 <span>Reading</span>
                 <span className="bottom-mini-dialog__shortcut">Ctrl + R</span>
                 {mode === 'reading' && (
               ...
               >
                 ...
                 <span>Edit</span>
                 <span className="bottom-mini-dialog__shortcut">Ctrl + E</span>
                 {mode === 'edit' && (
                   <svg className="bottom-mini-dialog__check-icon" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                     <polyline points="20,6 9,17 4,12"/>
                   </svg>
